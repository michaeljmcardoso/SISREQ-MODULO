            ...
            if event2 == sg.WINDOW_CLOSED or event2 == 'Fechar':
                ...
                salvar.extrair_planilha(registros)
                    ...
                    def alterarRegistroEspecifico():
                        ...
                        nome_municipio = selected_row_values[3]
                        ...
                        layoutAlterarDados = [
                            [
                                ...
                                sg.Input(size=(20, 1), key='-NOME_COMUNIDADE-', default_text=nome_municipio),
                                sg.Text('Município:'), 
...
def pesquisar_por_nome_municipio(nome_municipio):
    ...
    if registros:
        ...
        window3 = sg.Window('Registros por Nome do Município', layout_resultado, size=(1200, 1200), resizable=True)                                      
                ...
                def consultarRegistroEspecifico():
                    ...
                    layoutconsultarDados = [
                        [
                            ...
                            sg.Text('Município:'), 
                            sg.Combo(municipios, size=(18, 30), key='-MUNICIPIO-', default_value=municipio),
                            sg.Text('Área_ha:'), 
                            sg.Input(size=(14, 1), key='-AREA-', default_text=area_ha)
                        ],
                    ...
                    janelaconsultarDados = sg.Window('Consultar ou Alterar Registro', layoutconsultarDados, size=(1250, 650), resizable=True)
